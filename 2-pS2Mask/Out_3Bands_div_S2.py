...
def get_img_762bands(path):
    ...
    ''' S2: 7, 6, 1        L8: 6, 5, 1 '''
    img = rasterio.open(path).read((7, 6, 1)).transpose((1, 2, 0))  # Read specific bands and transpose to (height, width, bands)
        ...
        with rasterio.open(input_path) as src:
            ''' S2: 7
                ...
                L8: 6
                    ...
                    1 
            '''
            band7 = src.read(7) / 10000  # Read band 7 and normalize
            band6 = src.read(6) / 10000  # Read band 6 and normalize
            band5 = src.read(5) / 10000  # Read band 5 and normalize
...
if __name__ == "__main__":
    input_folder = "G:/fires/China_Sen2_all/China_Sen_17_pB12"
    output_tif_folder = "G:/fires/China_Sen2_all/Images/pS2China_Sen2_Filter"
    output_img_folder = "G:/fires/China_Sen2_all/Images/pS2JPGs"
    output_mask_folder = "G:/fires/China_Sen2_all/Images/pS2Masks"
    output_tif_Mask_folder = "G:/fires/China_Sen2_all/Images/pS2TifMasks"
